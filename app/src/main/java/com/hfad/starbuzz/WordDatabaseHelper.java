...
class WordDatabaseHelper extends SQLiteOpenHelper {
    ...
    private void updateMyDatabase(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE ENGLISH_WORD (_id INTEGER PRIMARY KEY AUTOINCREMENT, WORD TEXT NOT NULL, MEANING TEXT NOT NULL, TOPIC TEXT DEFAULT 'Out of topic', RATING INTEGER DEFAULT 0)");
        db.execSQL("CREATE TABLE GERMAN_WORD (_id INTEGER PRIMARY KEY AUTOINCREMENT, WORD TEXT NOT NULL, MEANING TEXT NOT NULL, TOPIC TEXT DEFAULT 'Out of topic', RATING INTEGER DEFAULT 0)");
        db.execSQL("CREATE TABLE POLISH_WORD (_id INTEGER PRIMARY KEY AUTOINCREMENT, WORD TEXT NOT NULL, MEANING TEXT NOT NULL, TOPIC TEXT DEFAULT 'Out of topic', RATING INTEGER DEFAULT 0)");
    }
